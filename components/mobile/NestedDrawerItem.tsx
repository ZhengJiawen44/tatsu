    ...
    <Drawer open={open} onOpenChange={setOpen}>
      <DrawerTrigger asChild disabled={disabled}>
        <button
          ...
          className={cn(
            clsx(
              "flex items-center justify-between w-full p-4 transition-colors hover:bg-accent/50 active:bg-accent",
              disabled &&
                "hover:bg-transparent! cursor-default! text-muted-foreground",
            ),
            className,
          )}
        >
