    ...
    <Popover modal={true} open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          type="button"
          className={cn(
            "h-fit px-2! gap-1 text-muted-foreground font-normal shrink-0",
            className,
          )}
        >
          {projectID ? (
            <>
              <ProjectTag id={projectID} className="text-sm pr-0" />{" "}
      ...
      <PopoverContent
        className="p-1 space-y-1 text-sm"
        align="start"
        alignOffset={-7}
      >
        <Input
