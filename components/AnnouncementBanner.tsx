...
//   const flipMeToShowBanner = false;

//   const [showModal, setShowModal] = useState(false);


//   useEffect(() => {
//     if (flipMeToShowBanner) {
//       setShowModal(localStorage.getItem("showBanner") === "true")
//     } else {
//       setShowModal(localStorage.getItem("showBanner") === "false")
