      ...
      >
        <Button
          ...
          className={clsx(
            ...
            activeMenu.name === "Note" && "bg-sidebar-primary",
          )}
        >
          <FileText
            className={clsx(
          ...
          {createLoading ? (
            ...
            showPlus && (
              <div
                className="ml-auto  hover:stroke-foreground! w-fit h-fit bg-inherit! cursor-pointer! text-muted-foreground hover:text-foreground "
