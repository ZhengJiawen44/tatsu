...
const Trash = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={className || ""}
    >
      <path d="M11.6251 2.875H1" stroke="#ffffff" strokeLinecap="round" />
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M4.75 6L5.0625 9.125" stroke="#ffffff" strokeLinecap="round" />
      <path d="M7.875 6L7.5625 9.125" stroke="#ffffff" strokeLinecap="round" />
      <path
