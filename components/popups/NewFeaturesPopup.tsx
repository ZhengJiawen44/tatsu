    ...
    >
      <CarouselItem>
        ...
        <p className="text-muted-foreground">
          A new calendar view can be found in the left sidebar, calendars are
          great for visualizing and planning your todos throughout the week
        </p>
      </CarouselItem>
      <CarouselItem>
        <Image
        ...
        <p className="text-muted-foreground">
          employ Natural language processing right in your todo title field to
          describe a start date or a duration
        </p>
      </CarouselItem>
      <CarouselItem>
        {/* <KeyboardShortcuts /> */}
        ...
        <p className="text-muted-foreground">
          Use intuitive shortcuts to perform your most important workflows
