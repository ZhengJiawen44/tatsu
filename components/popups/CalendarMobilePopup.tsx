    ...
    >
      <CarouselItem className="min-w-0 flex flex-col justify-center">
        ...
        <p className=" text-lg text-muted-foreground">
          Calendar events can also be resized or moved via drag-n-drop on
          mobile, but with a few caveats.
        </p>
      </CarouselItem>
      ...
      <CarouselItem className="min-w-0">
        ...
        <Image
          ...
          loading="lazy"
        />
        <h3 className="text-xl font-semibold mb-2">To resize an event</h3>
        <div className="text-muted-foreground">
          <ol className="list-decimal list-inside mt-2 space-y-1">
            <li> click on an event to select it</li>
