 ...
 */
export default function populateMetaProperties(
  childVeventComponent: ICAL.Component,
  masterVeventComponent: ICAL.Component,
) {
  ...
  allMasterProperties.forEach((masterProperty) => {
    ...
    switch (masterPropertyName) {
      ...
      case "created":
        childVeventComponent.addPropertyWithValue(
          "created",
          ICAL.Time.fromJSDate(dateNow, true),
        );
        break;
      case "dtstamp":
        childVeventComponent.addPropertyWithValue(
      ...
      default:
        childVeventComponent.addPropertyWithValue(
          masterPropertyName,
          masterVeventComponent.getFirstPropertyValue(masterPropertyName),
        );
        break;
    }
  });
