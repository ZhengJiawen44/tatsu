...
function parseRecurrenceOverride(
  ...
  return {
    ...
    overriddenDtstart:
      dtstartJs != null && (masterStart === undefined || dtstartJs.getTime() !== masterStart) ? dtstartJs : null,
    overriddenDue: dueJs != null && (masterDue === undefined || dueJs.getTime() !== masterDue) ? dueJs : null,
    overriddenDurationMinutes: core.durationMinutes !== master.durationMinutes ? core.durationMinutes : null
  }
}
 ...
 */
export function parseIcsDataWithInstances(icsData: string): ParsedIcsDataWithInstances | null {
