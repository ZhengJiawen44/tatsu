...
export default function RepeatDrawerMenu({
  rruleOptions,
  setRruleOptions,
  derivedRepeatType,
}: {
  ...
  return (
    <div className="p-4 space-y-4 w-full max-w-lg m-auto text-base">
      ...
      <div
        className={clsx(
          "flex w-full cursor-pointer items-center justify-between rounded-md p-2 hover:bg-accent/50",
          derivedRepeatType === "Daily" && "bg-accent",
        )}
        onClick={() =>
          setRruleOptions(() => {
      ...
      <div
        className={clsx(
          "flex w-full cursor-pointer items-center justify-between rounded-md p-2 hover:bg-accent/50",
          derivedRepeatType === "Weekly" && "bg-accent",
        )}
        onClick={() =>
          setRruleOptions(() => {
      ...
      <div
        className={clsx(
          "flex w-full cursor-pointer items-center justify-between rounded-md p-2 hover:bg-accent/50",
          derivedRepeatType === "Monthly" && "bg-accent",
        )}
        onClick={() =>
          setRruleOptions(() => {
      ...
      <div
        className={clsx(
          "flex w-full cursor-pointer items-center justify-between rounded-md p-2 hover:bg-accent/50",
          derivedRepeatType === "Yearly" && "bg-accent",
        )}
        onClick={() => {
          setRruleOptions(() => {
      ...
      <div
        className={clsx(
          "flex w-full cursor-pointer items-center justify-between rounded-md p-2 hover:bg-accent/50",
          derivedRepeatType === "Weekday" && "bg-accent",
        )}
        onClick={() =>
          setRruleOptions(() => {
            return {
      ...
      {rruleOptions && (
        <div
          className={clsx(
            "flex bg-inherit w-full cursor-pointer items-center justify-center border rounded-md p-2 hover:bg-red/40 hover:text-foreground! text-red",
            derivedRepeatType === "Monthly" && "bg-accent",
          )}
          onClick={() =>
            setRruleOptions(() => {
