      ...
      <div className="flex gap-2 items-center flex-wrap">
        {preferences?.groupBy && (
          <div className="bg-sidebar border py-1.5 px-3  rounded-md flex items-center gap-2 shrink-0">
            ...
            <span
              className="hover:text-lime cursor-pointer w-4 text-center"
        ...
        {preferences?.sortBy && (
          <div className="bg-sidebar border py-1.5 px-3  rounded-md">
            {filterDict(preferences.direction?.toLowerCase() || "ascending")}
          </div>
        )}
      </div>
      <DropdownMenu>
              ...
              <DropdownMenuPortal>
                <DropdownMenuSubContent>
                  ...
                  >
                    <DropdownMenuRadioItem
                      value="dtstart"
                      className="hover:bg-popover-accent"
                    >
