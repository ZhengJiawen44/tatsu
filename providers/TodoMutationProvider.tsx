...
export type useCompleteTodoType = () => {
  completeMutateFn: UseMutateFunction<
    void,
    Error,
    TodoItemType,
...
export type usePrioritizeTodoType = () => {
  prioritizeMutateFn: UseMutateFunction<
    void,
    Error,
    { id: string; level: "Low" | "Medium" | "High"; isRecurring: boolean },
...
export type useEditTodoInstanceType = (
  setEditInstanceOnly:
    React.Dispatch<React.SetStateAction<boolean>> | undefined,
) => {
  editTodoInstanceMutateFn: UseMutateFunction<
    void,
    Error,
    TodoItemType,
    { oldTodos: TodoItemType[] | undefined }
...
const TodoMutationContext = createContext<Omit<
  TodoMutaionProviderProps,
  "children"
> | null>(null);

export default function TodoMutationProvider({
  useDeleteTodo,
  useCompleteTodo,
  usePinTodo,
  usePrioritizeTodo,
...
export function useTodoMutation() {
  ...
  if (!context)
    throw new Error("useTodoMutation must be used within TodoMutationProvider");
  return context;
}
